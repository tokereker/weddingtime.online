...
// 2. Inicializamos Firebase de forma independiente (Sin auth.js)
...
document.addEventListener('DOMContentLoaded', () => {
    // Obtenemos los parámetros de la URL usando la "llave" del QR
...
function iniciarEscuchaInvitado(eventId) {
    // Apuntamos al documento del evento específico
    ...
    onSnapshot(docRef, (docSnap) => {
        if (docSnap.exists()) {
            ...
            // Actualizar Nombre del Evento y Colores
...
// Interacción: Abrir enlace del DJ
...
// Interacción: Simulación de Llamar Mesero
